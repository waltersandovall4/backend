...
namespace dw_backend.Controllers.Administracion.TipoPersona
{
    ...
    public class TipoPersonaController : ControllerBase
    {
        ...
        public TipoPersonaController(IConfiguration _configuration)
        {
            ...
            _nameProcedure = "adm.crudTipoPersona";
        }
        ...
        public IActionResult Store(TipoPersonaModel request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    resultado.message = "Tipo Persona agregado con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult Update(TipoPersonaModel request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Tipo Persona actualizado con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult Destroy(JObject request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Tipo Persona se ha dado de baja con éxito.";
                    resultado.value = 1;
        ...
        public IActionResult Active(JObject request)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(_nameProcedure, conn))
                {
                    ...
                    dynamic resultado = new JObject();
                    resultado.response = 1;
                    resultado.message = "Tipo Persona se ha dado de alta con éxito.";
                    resultado.value = 1;
